...
![Mapa mental: Principios y estrategias de muestreo](../imagenes/mapa-mental-muestreo.png){#fig-muestreo-mapa fig-alt="Diagrama de mapa mental que muestra las relaciones entre población, muestra, evidencia anecdótica, datos observacionales y métodos de muestreo aleatorio." width=0.7\textwidth height=0.4\textheight}
